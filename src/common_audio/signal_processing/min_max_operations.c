...
int16_t
WebRtcSpl_MaxAbsValueW16C(const int16_t *vector, size_t length)
{
    size_t i = 0;
...
int32_t
WebRtcSpl_MaxAbsValueW32C(const int32_t *vector, size_t length)
{
...
int16_t
WebRtcSpl_MaxValueW16C(const int16_t *vector, size_t length)
{
...
int32_t
WebRtcSpl_MaxValueW32C(const int32_t *vector, size_t length)
{
...
int16_t
WebRtcSpl_MinValueW16C(const int16_t *vector, size_t length)
{
...
int32_t
WebRtcSpl_MinValueW32C(const int32_t *vector, size_t length)
{
...
size_t
WebRtcSpl_MaxAbsIndexW16(const int16_t *vector, size_t length)
{
...
int16_t
WebRtcSpl_MaxAbsElementW16(const int16_t *vector, size_t length)
{
...
size_t
WebRtcSpl_MaxIndexW16(const int16_t *vector, size_t length)
{
    size_t i = 0, index = 0;
    int16_t maximum = WEBRTC_SPL_WORD16_MIN;
...
size_t
WebRtcSpl_MaxIndexW32(const int32_t *vector, size_t length)
{
    size_t i = 0, index = 0;
    int32_t maximum = WEBRTC_SPL_WORD32_MIN;
...
size_t
WebRtcSpl_MinIndexW16(const int16_t *vector, size_t length)
{
    size_t i = 0, index = 0;
    int16_t minimum = WEBRTC_SPL_WORD16_MAX;
...
size_t
WebRtcSpl_MinIndexW32(const int32_t *vector, size_t length)
{
    size_t i = 0, index = 0;
    int32_t minimum = WEBRTC_SPL_WORD32_MAX;
...
void
WebRtcSpl_MinMaxW16(const int16_t *vector, size_t length,
