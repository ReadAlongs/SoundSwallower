...
static __inline int
WebRtcSpl_CountLeadingZeros32_NotBuiltin(uint32_t n)
{
...
// Don't call this directly except in tests!
static __inline int
WebRtcSpl_CountLeadingZeros64_NotBuiltin(uint64_t n)
{
...
static __inline int
WebRtcSpl_CountLeadingZeros32(uint32_t n)
{
#ifdef __GNUC__
...
// Returns the number of leading zero bits in the argument.
static __inline int
WebRtcSpl_CountLeadingZeros64(uint64_t n)
{
#ifdef __GNUC__
...
WebRtcSpl_SatW32ToW16(int32_t value32)
{
...
WebRtcSpl_AddSatW32(int32_t a, int32_t b)
{
...
static __inline int32_t
WebRtcSpl_SubSatW32(int32_t a, int32_t b)
{
...
static __inline int16_t
WebRtcSpl_AddSatW16(int16_t a, int16_t b)
{
    return WebRtcSpl_SatW32ToW16((int32_t)a + (int32_t)b);
}

static __inline int16_t
WebRtcSpl_SubSatW16(int16_t var1, int16_t var2)
{
...
#if !defined(MIPS32_LE)
static __inline int16_t
WebRtcSpl_GetSizeInBits(uint32_t n)
{
...
static __inline int32_t
WebRtc_MulAccumW16(int16_t a, int16_t b, int32_t c)
{
    return (a * b + c);
}
