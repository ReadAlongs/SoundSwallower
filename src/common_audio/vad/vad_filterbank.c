...
//                        80 - 250 Hz.
static void
HighPassFilter(const int16_t *data_in, size_t data_length,
...
static void
AllPassFilter(const int16_t *data_in, size_t data_length,
...
//                        The length is `data_length` / 2.
static void
SplitFilter(const int16_t *data_in, size_t data_length,
...
static void
LogOfEnergy(const int16_t *data_in, size_t data_length,
...
int16_t
WebRtcVad_CalculateFeatures(VadInstT *self, const int16_t *data_in,
