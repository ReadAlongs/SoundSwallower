...
static int32_t
WeightedAverage(int16_t *data, int16_t offset,
...
static int16_t
GmmProbability(VadInstT *self, int16_t *features,
...
int
WebRtcVad_InitCore(VadInstT *self)
{
    int i;
...
int
WebRtcVad_set_mode_core(VadInstT *self, int mode)
{
    int return_value = 0;
...
int
WebRtcVad_CalcVad48khz(VadInstT *inst, const int16_t *speech_frame,
                       size_t frame_length)
{
    int vad;
    size_t i;
...
int
WebRtcVad_CalcVad32khz(VadInstT *inst, const int16_t *speech_frame,
                       size_t frame_length)
{
    size_t len;
    int vad;
...
int
WebRtcVad_CalcVad16khz(VadInstT *inst, const int16_t *speech_frame,
                       size_t frame_length)
{
    size_t len;
    int vad;
...
int
WebRtcVad_CalcVad8khz(VadInstT *inst, const int16_t *speech_frame,
                      size_t frame_length)
{
