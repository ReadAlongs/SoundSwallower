...
namespace webrtc_checks_impl {
    ...
    template <typename T,
              absl::enable_if_t<std::is_enum<T>::value && !std::is_arithmetic<T>::value> * = nullptr>
    ...
    public:
        template <typename U,
                  ...
                  absl::enable_if_t<std::is_arithmetic<U>::value || std::is_enum<U>::value> * = nullptr>
